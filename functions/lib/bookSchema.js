...
function list(value, maxItems = 30) {
...
export function normalizeBookInput(value) {
...
export function validateBookInput(book) {
    ...
    if (!/^[0-9]{3}$/.test(book.categoryCode))
        return 'รหัสหมวดต้องเป็นตัวเลข 3 หลัก';
